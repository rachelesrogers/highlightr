...
After colors have been assigned, highlighted text is created based on frequency, as well as a gradient bar indicating the high and low values.
...
```{r, message=FALSE, warning=FALSE}
collocation_object_2col <- collocate_comments_fuzzy(toks_transcript, toks_comment, collocate_length = 2)
