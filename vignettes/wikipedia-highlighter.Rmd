...
This text indicates changes to the Wikipedia article, where darker colors appeared in the most versions (yellow as the primary highlight color and information regarding the trilighter).
Lighter colors indicate text that is seen in fewer versions of the article (such as the introductory sentence and the reference to correction tape).
...
Note the counts for the gradient here are larger than those of the most recent article - with a minimum average collocation of 51 and a maximum average collocation of 496.
