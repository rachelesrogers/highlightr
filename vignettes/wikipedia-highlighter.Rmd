...
page_highlight <- highlighted_text(freq_plot, merged_frequency, labels=c("(fewest articles)", "(most articles)"))
```
...
page_highlight2 <- highlighted_text(freq_plot2, merged_frequency2, labels=c("(fewest articles)", "(most articles)"))
